...
type Querier interface {
	...
	GetCourseSectionsByStudentID(ctx context.Context, studentID uuid.UUID) ([]CourseSection, error)
	GetCourseSectionsByTeacherID(ctx context.Context, teacherID uuid.UUID) ([]CourseSection, error)
	GetCourseSectionsWithSchedulesByStudentID(ctx context.Context, studentID uuid.UUID) ([]GetCourseSectionsWithSchedulesByStudentIDRow, error)
